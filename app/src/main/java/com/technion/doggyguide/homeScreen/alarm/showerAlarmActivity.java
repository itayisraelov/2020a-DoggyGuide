...
public class showerAlarmActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener{
    ...
    CollectionReference mShowerAlarms = db.collection("dogOwners/"
            + mAuth.getCurrentUser().getUid() + "/showerAlarm");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Shower Alarm");
    ...
    private void setUpRecyclerView() {
        Query query = mShowerAlarms.orderBy("time", Query.Direction.ASCENDING);
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        ...
        AlarmElement alarm = new AlarmElement(timeText, false, alarmId, hourOfDay, minute, "showerAlarm");
        mShowerAlarms.document(alarmId)
                .set(alarm)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Log.d("Shower Alarm", "Reminder added");
                    }
                });
    }
}
